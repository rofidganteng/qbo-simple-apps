...
$estimate = $dataService->FindbyId('estimate', 208);
...
if ($error) {
    ...
    echo "Created Id={$estimate->Id}. Reconstructed response body:\n\n";
    $xmlBody = XmlObjectSerializer::getPostXmlFromArbitraryEntity($estimate, $urlResource);
    echo $xmlBody . "\n";
}
