...
$billpayment = $dataService->FindbyId('billpayment', 213);
...
if ($error) {
    ...
    echo "Created Id={$billpayment->Id}. Reconstructed response body:\n\n";
    $xmlBody = XmlObjectSerializer::getPostXmlFromArbitraryEntity($billpayment, $urlResource);
    echo $xmlBody . "\n";
}
